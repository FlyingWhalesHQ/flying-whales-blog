...
Here the result on a pretrained model. Notice the middle image input is a drawing - and it has a hand next to the face - making it a bit more difficult to emulate.
